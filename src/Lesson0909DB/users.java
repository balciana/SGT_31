...
//
//                }else if(action == 'd'){
//                    System.out.println("Enter username name that you want to delete");
...
//            }
//            //readData(conn);
//            //inserting data in table (carefull every time when we execute it creates new line
//            //insertData(conn, "kzars", "qwerty", "Karlis Zars", "zarskarsis@gnail.com");
//
//        }catch (Exception e){
//            e.printStackTrace();
//        }
...
//
//        //execute the
//        //returns int and shows how many rows were affected
